...
<div class="weadmin-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 we-search" onsubmit="return false;">
            ...
            <div class="layui-inline">
                <input type="text" id="un" name="username" placeholder="请输入用户名关键字" autocomplete="off" class="layui-input">
            </div>
            <button id="load" class="layui-btn" lay-submit="" lay-filter="search" data-type="reload"><i class="layui-icon">&#xe615;</i></button>
        </form>
    </div>
    ...
    <script type="text/html" id="operateTpl">
        <a title="编辑" onclick="WeAdminEdit('编辑','${pageContext.request.contextPath}/search?id={{d.id}}', 2, 600, 400)" href="javascript:;">
            <i class="layui-icon">&#xe642;</i>
        </a>
        <a title="删除" href="javascript:deluser({{d.id}})">
            <i class="layui-icon">&#xe640;</i>
        </a>
    </script>
    ...
    <script type="text/html" id="mySex">
            <div class="layui-form">{{0==d.sex?'男':'女'}}</div>
    </script>
    <script type="text/html" id="myisadmin">
        <div class="layui-form">{{0==d.isadmin?'管理员':'普通用户'}}</div>
    </script>
    <!--时间格式化-->
